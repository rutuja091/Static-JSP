...
<body>
    ...
    <div class="card">
        ...
        <div class="card-content">
          ...
          <p class="card-price">RAM-32 gb</p>
      ...
      <div class="card">
        <img src="./../Images/Lenovo/lenovohedset.jpeg" alt="Product Image">
        <div class="card-content">
          <h3 class="card-title">Headset</h3>
          <p class="card-price">Usb headset</p>
          <div class="card-rating">
            ⭐⭐⭐⭐⭐ (4.8)
          </div>
          <div class="card-buttons">
      ...
      <div class="card">
        <img src="./../Images/Lenovo/tab.jpg" alt="Product Image">
        <div class="card-content">
          <h3 class="card-title">tab</h3>
          <p class="card-price">Smart tab</p>
          <div class="card-rating">
            ⭐⭐⭐⭐⭐ (4.8)
          </div>
          <div class="card-buttons">
