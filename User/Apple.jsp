...
<body>
    ...
    <div class="image-banner">
        <img src="./../Images/apple/adimg.webp" alt="Banner Image">
      <!--  <div class="caption"></div> -->
    </div>


    <div class="main-head">
      <p id="dark-light-main-header"><b>Apple Product</b></p>
    </div>

    <!-- Main Content Placeholder -->
    <div class="cardcontainer">
    <div class="card">
        <img src="./../Images/apple/ipad.jpg" alt="Product Image">
      ...
      <div class="card">
        <img src="./../Images/apple/watch2.jpg" alt="Product Image" >
        <div class="card-content">
          <h3 class="card-title">Smart Watch</h3>
          <p class="card-price">Series 10 Gps</p>
          <div class="card-rating">
            ⭐⭐⭐ (4.8)
          </div>
          <div class="card-buttons">
      ...
      <div class="card">
        <img src="./../Images/apple/airpod.webp" alt="Product Image">
        <div class="card-content">
          <h3 class="card-title">Airpod</h3>
          <p class="card-price">Gen 3</p>
          <div class="card-rating">
            ⭐⭐⭐ (3)
          </div>
          <div class="card-buttons">
