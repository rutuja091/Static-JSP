     ...
     <div class="containers3">
          ...
          <div class="movie-card-container">
              <div class="movie-cards movie-card-1">
                  <img src="./../Images/intel-logo.jpg" alt="The Way of Water" class="movie-image">
              ...
              <div class="movie-cards movie-card-2">
                  <img src="./../Images/applelogo.jpg" alt="The Witcher Season 2" class="movie-image"   style="width:340px;height:200px;">
                  <div class="movie-info">
                      <h3 class="movie-title"></h3>
                      <p class="movie-genre"></p>
              ...
              <div class="movie-cards movie-card-3">
                  <img src="./../Images/lenovo.jpg" alt="Wrong Turns Part 2" class="movie-image">
                  <div class="movie-info">
                      <h3 class="movie-title"></h3>
                      <p class="movie-genre"></p>
                   </div>
      ...
      <div class="containers3">
        ...
        <div class="movie-card-container">
            <div class="movie-cards movie-card-1">
                <img src="./../Images/mi.jpg" alt="The Way of Water" class="movie-image">
                <div class="movie-info">
                    <h3 class="movie-title"></h3>
                    <p class="movie-genre"> </p>
            ...
            <div class="movie-cards movie-card-2">
                <img src="./../Images/Hitachi2-logo.jpg" alt="The Witcher Season 2" class="movie-image"   style="width:340px;height:200px;">
                <div class="movie-info">
                    <h3 class="movie-title"></h3>
                    <p class="movie-genre"></p>
            ...
            <div class="movie-cards movie-card-3">
                <img src="./../Images/samsung.jpg" alt="Wrong Turns Part 2" class="movie-image">
                <div class="movie-info">
                    <h3 class="movie-title"></h3>
                    <p class="movie-genre"></p>
                 </div>
